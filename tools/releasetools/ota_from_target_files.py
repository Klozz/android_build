...
""" % bcb_dev)
  ...
  script.Print("");
   ...
   script.Print(" _________________________________________________________________________________________________________________________________________________");
   script.Print("|                                                                                                                                                 |");
   script.Print("|                                                                                                                                                 |");
   script.Print("|________/\\\\\\\\\________________________________________________________________________________________/\\\\\__________/\\\\\\\\\\\___        |"); 
   script.Print("| _____/\\\////////_______________________________________________________________________________________/\\\///\\\______/\\\/////////\\\_       |"); 
   script.Print("|  ___/\\\/___________________________________________________________/\\\_______________________________/\\\/__\///\\\___\//\\\______\///__      |");      
   script.Print("|   __/\\\_________________/\\\\\_____/\\\\\\\\\\____/\\\\\__/\\\\\___\///______/\\\\\\\\__/\\\\\\\\\\\__/\\\______\//\\\___\////\\\_________     |");   
   script.Print("|    _\/\\\_______________/\\\///\\\__\/\\\//////___/\\\///\\\\\///\\\__/\\\___/\\\//////__\///////////__\/\\\_______\/\\\______\////\\\______    |"); 
   script.Print("|     _\//\\\_____________/\\\__\//\\\_\/\\\\\\\\\\_\/\\\_\//\\\__\/\\\_\/\\\__/\\\_______________________\//\\\______/\\\__________\////\\\___   |"); 
   script.Print("|      __\///\\\__________\//\\\__/\\\__\////////\\\_\/\\\__\/\\\__\/\\\_\/\\\_\//\\\_______________________\///\\\__/\\\_____/\\\______\//\\\__  |"); 
   script.Print("|       ____\////\\\\\\\\\__\///\\\\\/____/\\\\\\\\\\_\/\\\__\/\\\__\/\\\_\/\\\__\///\\\\\\\\__________________\///\\\\\/_____\///\\\\\\\\\\\/___ |");  
   script.Print("|        _______\/////////_____\/////_____\//////////__\///___\///___\///__\///_____\////////_____________________\/////_________\///////////_____|");
   script.Print("|                                                                                                                                                 |");
   script.Print("|_________________________________________________________________________________________________________________________________________________|");
